...
import bankReducer, { actions } from "./BankReducer";
...
const BankAccountApp = () => {
    const [bankState,dispatch] =  useReducer(bankReducer,initialState);
    const {isActive,balance,loan} = bankState;

    const handleOpenAccount = () =>{
        dispatch({
            type:actions.openAccount
        })
    }
    const handleDeposit = () =>{
        dispatch({
